...
MIN_MEMBER_COUNT: int = get_env_int("MIN_MEMBER_COUNT", 2)
...
SUPPORT_GROUP: str = getenv("SUPPORT_GROUP", "https://t.me/ironmanhindigming1")
SUPPORT_CHANNEL: str = getenv("SUPPORT_CHANNEL", "https://t.me/irotechlab")
